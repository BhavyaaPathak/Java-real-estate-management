...
public class ManagementRole extends Role {
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, Organization organization, Enterprise enterprise,Network network, UserAccount userAccount, Government govt) {
        return new ManagementMainJPanel(userProcessContainer, organization, enterprise, network, userAccount, govt); //To change body of generated methods, choose Tools | Templates.
    }
